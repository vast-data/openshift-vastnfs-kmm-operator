...
main() {
    ...
    echo "1. Ensure the public key is enrolled in the MOK database on secure boot nodes"
    echo "2. The signing process may take several minutes to complete"
    echo "3. Monitor the deployment using the commands shown above"
    echo ""
}
